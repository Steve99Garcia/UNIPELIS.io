  ...
  try {
    ...
    if (respuesta.status === 200) {
      ...
      datos.results.forEach((pelicula) => {
        peliculas += `
					<div class="pelicula">
					 	  <a href="unipeli2.html?id=${pelicula.id}"><img class="poster" src="https://image.tmdb.org/t/p/w500/${pelicula.poster_path}"></a>
					</div>
				`;
      });
  ...
  try {
    ...
    if (respuesta.status === 200) {
      ...
      datos.results.forEach((pelicula) => {
        peliculas += `
					<div class="pelicula" >
					  <a href="uniseries2.html?id=${pelicula.id}"><img class="poster" src="https://image.tmdb.org/t/p/w500/${pelicula.poster_path}"></a>
					</div>
				`;
      });
